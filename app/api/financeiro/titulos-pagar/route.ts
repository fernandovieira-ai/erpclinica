...
// GET /api/financeiro/titulos-pagar?busca=&status=&data_inicio=&data_fim=&page=1&limit=50
...
// POST /api/financeiro/titulos-pagar
  ...
  const { rows } = await db.query(
    `INSERT INTO tab_titulo_pagar
       (empresa_id, pessoa_id, tipo_despesa_id, cod_tipo_cobranca,
        ...
        status, requer_aprovacao, status_aprovacao,
        codigo_barras, nosso_numero, observacao, created_by)
