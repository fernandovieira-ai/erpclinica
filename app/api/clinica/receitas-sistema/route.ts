  ...
  if (dados && agId) {
    const { rows } = await db.query(
      `SELECT prof.nome                                      AS profissional_nome,
              ...
              pac.logradouro                                 AS paciente_logradouro,
              pac.numero                                     AS paciente_numero,
              pac.complemento                                AS paciente_complemento,
              pac.bairro                                     AS paciente_bairro,
              pac.cidade                                     AS paciente_cidade,
              pac.uf                                         AS paciente_uf,
