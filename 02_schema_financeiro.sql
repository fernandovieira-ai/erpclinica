...
-- A API só precisa fazer UPDATE SET status='L', data_liquidacao,
-- valor_liquidado, conta_banco_id (ou NULL para caixa)
-- =============================================================
...
--   conta_banco_id NOT NULL → movimento banco (S)
--   conta_banco_id NULL     → movimento caixa (S)
--
